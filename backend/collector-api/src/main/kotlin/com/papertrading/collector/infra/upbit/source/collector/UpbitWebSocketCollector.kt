...
import com.papertrading.collector.infra.upbit.UpbitProperties
...
class UpbitWebSocketCollector(
	...
	private fun buildSubscribePayload(): ByteArray {
		...
		val selected = upbitMarketCatalogService.selected().map { it.market }
		val markets = if (selected.isNotEmpty()) selected else properties.markets
