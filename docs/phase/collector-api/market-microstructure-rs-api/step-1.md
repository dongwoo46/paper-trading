...
3. Design API spec for market microstructure and relative-strength queries.
4. Design DB/Redis schema and access policy (key naming, TTL, fallback contract).
5. Write spec.md.
6. Generate step-2.md to step-N.md with concrete implementation directives.
   ...
   - Include domestic/overseas common contract rules: session, timezone normalization, missing-data policy.
   - Include response contracts for quote/depth, trade-intensity/volume, RS vs benchmark or sector.
